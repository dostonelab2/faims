      ...
      <?php
        echo GridView::widget([
            ...
            'panel' => [
                    ...
                    'before'=>Html::button('New LDDAP-ADA ( <b>'.$count.'</b> )', ['value' => Url::to(['lddapada/create']), 'title' => 'LDDAP-ADA', 'class' => 'btn btn-info', 'style'=>'margin-right: 6px;', 'id'=>'buttonCreateLddapada']),
                    'after'=>false,
                ],
            // set your toolbar
            'toolbar' => 
