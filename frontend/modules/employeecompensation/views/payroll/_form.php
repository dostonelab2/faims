    ...
    <div class="row">
        ...
        <div class="col-md-6"> 
                ...
                <?= $form->field($model, 'request_type_id')->widget(Select2::classname(), [
                    'data' => ArrayHelper::map(Requesttype::find()->where(['active'=>1, 'payroll'=>1])->all(),'request_type_id','name'),
                    'language' => 'en',
    ...
    <div class="row">
        ...
        <div class="col-md-6"> 
                ...
                <?= $form->field($model, 'obligation_type_id')->widget(Select2::classname(), [
                    'data' => ArrayHelper::map(Obligationtype::find()->where(['active' => 1])->all(),'type_id','name'),
                    'language' => 'en',
