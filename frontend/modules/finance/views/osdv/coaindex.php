            ...
            'columns' => [
                            ...
                            [
                                ...
                                'value'=>function ($model, $key, $index, $widget) { 
                                    ...
                                    return ($model->osdv ? 
                                    '<b>'.Html::a(Creditor::findOne($model->payee_id)->name, ['osdv/coaview', 'id'=>$model->osdv->osdv_id], ['style' => 'font-size: medium;', 'target' => '_blank', 'data-pjax'=>0]).'</b><br/>' :
                            ...
                            [
                                ...
                                'buttons' => [
                                    'view' => function ($url, $model){
                                        return $model->osdv ? Html::button('<span class="glyphicon glyphicon-eye-open"></span>', ['value' => '/finance/osdv/coaview?id=' . $model->osdv->osdv_id,'onclick'=>'location.href=this.value', 'class' => 'btn btn-primary', 'title' => Yii::t('app', "View OSDV")]) : '';
                                    },
