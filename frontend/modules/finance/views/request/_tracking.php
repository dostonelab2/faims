...
<!--            <div class="steps d-flex flex-wrap justify-content-between padding-top-2x padding-bottom-1x">-->
...
<?php //$this->registerCssFile("@web/css/pe-icon-7-stroke.min.css"); ?>
<?php $this->registerCssFile("@web/css/steps.css"); ?>
