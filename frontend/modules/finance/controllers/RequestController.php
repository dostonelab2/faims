...
class RequestController extends Controller
{
    ...
    {
        $searchModel = new RequestSearch();
        if( (Yii::$app->user->identity->username == 'Admin') || (Yii::$app->user->can('access-finance-verification')) || (Yii::$app->user->can('access-finance-documentcollation')) )
    ...
    public function actionValidateindex()
    {
        ...
        }elseif(Yii::$app->user->identity->user_id == 9){
            $searchModel->division_id = [2,3];
        }
        /*if(Yii::$app->user->identity->user_id == 2){
            $searchModel->payee_id = [129,117];
            $searchModel->user_id = 2;
    ...
    {
        $request = Requestpayroll::findOne($id);
