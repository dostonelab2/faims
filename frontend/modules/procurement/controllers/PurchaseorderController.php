...
<tfoot>
    <tr>
        <td style="width: 87%; text-align: left;border:none;border:1px solid black;background:white;" colspan="5">'.strtoupper((fmod($summary,1) !== 0.00) ?  Yii::$app->formatter->asSpellout(round($summary,0)). " AND " . substr(number_format($summary,2),strlen(number_format($summary,2))-2,strlen(number_format($summary,2))) ."/100" : Yii::$app->formatter->asSpellout($summary)). " PESOS ONLY".'</td>
